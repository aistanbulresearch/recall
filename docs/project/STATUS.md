...
- Current product commit `29a833c30e16d70edccadbe10d574769f542787e` shifts only the six owner-declared windows before any cycle ran; frozen `CohortDayManifest 2.1.0`, legacy `RUN_PREDICTIONS`, logical due dates, predictions, trigger policies, case identities and semantic payload values, frozen Day-1 evidence, and `infra/**` are unchanged.
- `COMPRESSED_PREDICTION_PLAN_V2` is the single timing source. Its current committed SHA-256 is `05e61f4bbe3d6bb7540ecae310e3c6f9423dcae3a7933db59ef4267e84fd9226`; c1-c5 predict 3/2/4/1/1 runs, and c6 prepares 450 onboarding cases but remains conditional on the measured headroom receipt.
...
- The preparation bundle was regenerated from the shifted product commit: SHA-256 `4487e4d3e5973e0e714348f1d420a9328046ed1ba49f5c1a0478e9f174b90d04`, 462 cases, five hash-verified replay observations, no persisted signing key. Identities and semantic payload values are stable; provenance timestamps/content hashes, schedule epochs, and the required plan-hash/source binding were regenerated. `SYNTHETIC_WITH_CAPTURED_REPLAY` is preserved transitively.
